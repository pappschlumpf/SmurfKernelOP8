...
ZIMAGE_DIR="../SmurfKernelOP8/arch/arm64/boot/"
...
function make_kernel {
	      cp ../SmurfKernelOP8/Makefile.gcc10 ../SmurfKernelOP8/Makefile
	      echo
...
function make_boot {
		cp -vr ../SmurfKernelOP8/out/arch/arm64/boot/Image-dtb ../AnyKernel2/Image-dtb
}
...
function make_sep_dtb {
	find ../SmurfKernelOP8/out/arch/arm64/boot/dts/vendor/qcom -name '*.dtb' -exec cat {} + > ../SmurfKernelOP8/out/arch/arm64/boot/dtb
}
DATE_START=$(date +"%s")
